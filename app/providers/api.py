...
async def auth_provider(code:str):
    print(code)
    r = httpx.get('https://api.vkontakte.ru/oauth/access_token?client_id=8048750&client_secret=EF4OzopruPvy1t2h770U&rediect_uri=https://ralae.com/vk/cross&code={code}')
    return r.text